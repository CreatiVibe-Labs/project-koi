...
export default function WhyChooseUs({ title, text }) {
    ...
    const [parent4, setParent4] = useState(false);
    const [parent5, setParent5] = useState(false);
    const [parent6, setParent6] = useState(false);
    return (
        <>
            ...
            <div className="svgGraph">
                ...
                <svg width="597" height="594" viewBox="0 0 597 594" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g class="flowGroup point6" onMouseEnter={() => setParent6(true)} onMouseLeave={() => setParent6(false)}>
                        <path className='flowBg' d="M205.562 171.897L200.829 128.481L236.128 154.216C253.284 146.751 272.018 142.233 291.738 141.447V0C187.814 2.35745 96.9062 57.561 45.4375 139.875L168.489 210.599C178.546 195.668 190.97 182.506 205.562 171.897Z" fill={hovered6 ? '#39ff14' : '#ACEDBB'} />
                    ...
                    <g class="flowGroup point4" onMouseEnter={() => setParent4(true)} onMouseLeave={() => setParent4(false)}>
                        <path className='flowBg' d="M200.829 465.197L205.562 421.781C190.97 411.172 178.546 398.01 168.489 382.883L45.4375 453.606C96.9062 535.92 187.814 591.124 291.738 593.481V452.035C272.018 451.249 253.284 446.73 236.128 439.265L200.829 465.197Z" fill={hovered4 ? '#39ff14' : '#ACEDBB'} />
                    ...
                    <g class="flowGroup point3" onMouseEnter={() => setParent3(true)} onMouseLeave={() => setParent3(false)}>
                        <path className='flowBg' d="M431.943 377.586C421.491 394.874 407.49 410.001 391.32 421.985L396.053 465.401L360.754 439.665C343.598 447.131 324.864 451.649 305.145 452.435V593.882C411.434 591.524 504.117 533.767 554.994 448.506L431.943 377.586Z" fill={hovered3 ? '#39ff14' : '#ACEDBB'} />
                    ...
                    <g class="flowGroup point2" onMouseEnter={() => setParent2(true)} onMouseLeave={() => setParent2(false)}>
                        <path className='flowBg' d="M561.305 157.164L438.254 227.887C446.142 243.604 451.466 261.088 453.438 279.358L493.469 296.843L453.438 314.327C451.269 332.597 446.142 349.885 438.254 365.798L561.305 436.521C583.589 394.873 596.407 347.331 596.407 296.843C596.407 246.354 583.589 198.812 561.305 157.164Z" fill={hovered2 ? '#39ff14' : '#ACEDBB'} />
                    ...
                    <g class="flowGroup point1" onMouseEnter={() => setParent1(true)} onMouseLeave={() => setParent1(false)}>
                        <path className='flowBg' d="M396.055 128.488L391.322 171.904C407.492 183.888 421.493 199.014 431.945 216.302L554.799 145.579C503.922 60.318 411.436 2.36412 304.949 0.203125V141.65C324.669 142.436 343.403 146.954 360.559 154.419L396.055 128.488Z" fill={hovered1 ? '#39ff14' : '#ACEDBB'} />
                        <path className='flowBgText' d="M408.28 85.9382V78.4026H421.408V113H412.972V85.9382H408.28Z" fill="#0F1910" />
                    </g>
                </svg>

                <Image id="image0_665_53712" src="/images/logo.png" width={100} height={100} alt="logo" />

            </div>

            <div className='whyChooseUsContent'>
                <div className='step-1 step' style={parent1 ? { backgroundImage: 'url("/images/step1_hover.png")' } : {}} onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)}>
                    <h6>Assessment</h6>
                    <p>We begin by understanding your needs,<br /> goals, and technical environment</p>
                </div>
                <div className='step-2 step' style={parent2 ? { backgroundImage: 'url("/images/step2_hover.png")' } : {}} onMouseEnter={() => setHovered2(true)} onMouseLeave={() => setHovered2(false)}>
                    <h6>Design</h6>
                    <p>Wireframes and prototypes shape the<br /> ideal user experience.</p>
                </div>
                <div className='step-3 step' style={parent3 ? { backgroundImage: 'url("/images/step3_hover.png")' } : {}} onMouseEnter={() => setHovered3(true)} onMouseLeave={() => setHovered3(false)}>
                    <h6>Development</h6>
                    <p>Our engineers bring your solution to life<br /> using agile sprints.</p>
                </div>
                <div className='step-4 step' style={parent4 ? { backgroundImage: 'url("/images/step4_hover.png")' } : {}} onMouseEnter={() => setHovered4(true)} onMouseLeave={() => setHovered4(false)}>
                    <h6>Testing</h6>
                    <p>Rigorous QA ensures functionality,<br /> security, and performance.</p>
                </div>
                <div className='step-5 step' style={parent5 ? { backgroundImage: 'url("/images/step5_hover.png")' } : {}} onMouseEnter={() => setHovered5(true)} onMouseLeave={() => setHovered5(false)}>
                    <h6>Deployment</h6>
                    <p>We handle rollout, scaling</p>
                </div>
                <div className='step-6 step' style={parent6 ? { backgroundImage: 'url("/images/step6_hover.png")' } : {}} onMouseEnter={() => setHovered6(true)} onMouseLeave={() => setHovered6(false)}>
                    <h6>Support</h6>
