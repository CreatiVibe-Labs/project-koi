                ...
                <div className='section1 lg:gap-12 gap-6'>
                    <div className='group1 flex flex-col md:gap-4 gap-2'>
                        <div className='logoWrapper'>
                            <Link href='/' className='flex gap-2.5 md:gap-5 items-center font-semibold lg:text-4xl md:text-2xl text-lg'><Image src="/images/logo.png" width={100} height={10} alt="Logo" />Aerialink</Link>
                        </div>
