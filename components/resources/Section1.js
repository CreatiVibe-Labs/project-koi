        ...
        {cardsData.map((card) => {
          ...
          return (
            <a
              ...
              className={`flex items-center justify-start gap-2 xs:gap-3 md:gap-2 px-2 xs:px-3 sm:px-3 md:px-4 py-3 xs:py-4 sm:py-4 md:py-5 backdrop-blur-[15px] rounded-[18px] border cursor-pointer w-full transition-all duration-200
                ${isActive ? " border-white/40" : "border-white/40"}`}
            >
              <Image
              ...
              />
              <span
                className={`font-bold text-left flex-1 min-w-0 whitespace-nowrap truncate tracking-tight leading-tight ${isActive ? "text-[#39FF14]" : "text-white"} text-sm xs:text-base md:text-xl lg:text-xl`}
              >
                {card.title}
              </span>
            </a>
