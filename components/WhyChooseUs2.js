...
export default function WhyChooseUs({ title, text }) {
    ...
    return (
        <>
            ...
            <div className="svgGraph services">

                <svg width="400" height="618" viewBox="0 0 600 599" fill="none" xmlns="http://www.w3.org/2000/svg">

                    <g className="flowGroup point4" onMouseEnter={() => setParent4(true)} onMouseLeave={() => setParent4(false)}>
                        <path className='flowBg' d="M292.93 143.472C258.56 144.876 227.049 157.364 201.875 177.458L165.079 163.984L178.463 200.537C157.542 225.993 144.501 258.168 143.064 293.337H0C3.412 133.09 132.683 3.81825 292.93 0.40625V143.472Z" fill={hovered4 ? '#39ff14' : '#ACEDBB'} />
                    ...
                    <g className="flowGroup point3" onMouseEnter={() => setParent3(true)} onMouseLeave={() => setParent3(false)}>
                        <path className='flowBg' d="M143.087 306.406C144.746 341.579 158.016 373.711 179.149 399.06L167.178 431.755L199.958 419.75C225.437 440.743 257.67 453.831 292.907 455.271V598.336C132.994 594.931 3.92722 466.191 0 306.406H143.087Z" fill={hovered3 ? '#39ff14' : '#ACEDBB'} />
                    ...
                    <g className="flowGroup point2" onMouseEnter={() => setParent2(true)} onMouseLeave={() => setParent2(false)}>
                        <path className='flowBg' d="M598.907 306.406C594.988 465.857 466.451 594.394 307 598.313V455.227C342.146 453.568 374.256 440.317 399.596 419.211L433.85 431.755L421.224 397.274C441.504 372.21 454.199 340.758 455.82 306.406H598.907Z" fill={hovered2 ? '#39ff14' : '#ACEDBB'} />
                    ...
                    <g className="flowGroup point1" onMouseEnter={() => setParent1(true)} onMouseLeave={() => setParent1(false)}>
                        <path className='flowBg' d="M307.5 0C467.284 3.92721 596.025 132.995 599.43 292.908H456.365C454.941 258.041 442.108 226.117 421.501 200.766L434.35 165.678L399.358 178.49C374.135 157.74 342.305 144.729 307.5 143.087V0Z" fill={hovered1 ? '#39ff14' : '#ACEDBB'} />
            ...
            <div className='whyChooseUsContent service_flowChart'>
                ...
                <div className='step-3 step' style={parent2 ? { backgroundImage: 'url("/images/step2_hover.png")' } : {}} onMouseEnter={() => setHovered2(true)} onMouseLeave={() => setHovered2(false)}>
                    <h6>Engagement</h6>
                </div>
                <div className='step-4 step' style={parent3 ? { backgroundImage: 'url("/images/step5_hover.png")' } : {}} onMouseEnter={() => setHovered3(true)} onMouseLeave={() => setHovered3(false)}>
                    <h6>Conversion</h6>
                </div>
                <div className='step-6 step' style={parent4 ? { backgroundImage: 'url("/images/step6_hover.png")' } : {}} onMouseEnter={() => setHovered4(true)} onMouseLeave={() => setHovered4(false)}>
                    <h6>Retention</h6>
                </div>
            </div>
        </>
