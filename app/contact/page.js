                    ...
                    <div className="contactBg backdrop-blur-lg border-0 border-amber-50 rounded-2xl md:p-10 p-2.5 flex items-end">
                        <ul>
                            ...
                            <li className="flex items-center gap-5">
                                ...
                                <Link href="https://maps.app.goo.gl/x4bdhdoMwSufLe31A" target="_blank" className="flex items-center  gap-5 custom-shaodw">  6E-02, 6-9 Koyocho-naka, Higashinada-ku, Kobe<br />
                                    Hyogo, 658-0032 Japan</Link>
                            </li>
                        </ul>
